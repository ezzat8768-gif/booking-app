          ...
          <div style={{ textAlign: "center", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 24, padding: 48 }}>
            ...
            <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
              <a href={`https://wa.me/?text=${encodeURIComponent(`✅ تأكيد حجز موعد\n\nرقم الحجز: ${bookingRef}\nالاسم: ${form.name}\nالخدمة: ${selectedService?.name}\nالتاريخ: ${form.date}\nالوقت: ${selectedTime}\nالسعر: ${selectedService?.price}\n\nشكراً لحجزك معنا! 🙏`)}`}
                target="_blank"
                style={{ padding: "14px 24px", background: "#25d366", color: "#fff", border: "none", borderRadius: 12, fontSize: 16, fontWeight: 700, cursor: "pointer", fontFamily: "Cairo", textDecoration: "none", display: "flex", alignItems: "center", gap: 8 }}>
                📲 ارسل تأكيد الحجز على واتساب
              </a>
              <button onClick={resetBooking}
                style={{ padding: "14px 24px", background: "#3b82f6", color: "#fff", border: "none", borderRadius: 12, fontSize: 16, fontWeight: 700, cursor: "pointer", fontFamily: "Cairo" }}>
                حجز موعد جديد
              </button>
            </div>
          </div>
